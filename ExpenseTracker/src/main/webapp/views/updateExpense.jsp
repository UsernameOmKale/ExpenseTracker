...
<body>
    ...
    <div class="content">
        ...
        <form action="updateExpenseSuc?id=${user.id}" method="post">
            <!-- Hidden fields -->
            ...
            <div class="form-group">
                ...
                <input type="text" id="expenseName" name="expenseName" required 
                       placeholder="Enter expense name" value="${exp.expenseName}">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="expenseDescription" name="expenseDescription" 
                          placeholder="Enter description (optional)">${exp.expenseDescription}</textarea>
            </div>
